...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(action.equalsIgnoreCase(ACTION_PLAY)){
            ...
            RadioClass.iv_gif.setVisibility(View.GONE);
            RadioClass.iv_pause.setVisibility(View.GONE);
            RadioClass.iv_play.setVisibility(View.VISIBLE);
          //  RadioClass.progressDialog.dismiss();
    ...
    public void playOrPause(String url){
        Log.i("Radio service url>>>>>",url);
    //    Log.i("Radio service Streams>>",streamUrl);
