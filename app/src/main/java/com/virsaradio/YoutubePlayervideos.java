...
public class YoutubePlayervideos extends AppCompatActivity implements YouTubePlayer.OnInitializedListener,View.OnClickListener{
//AIzaSyBFt53n6FcbEjACSLBvqZXVoXBrvgSsibc
...
//    YouTubePlayerSupportFragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_backarrow=(ImageView)findViewById(R.id.iv_back);
        ClickListener();
...
//                      youTubePlayer2.play();
    ...
    public void onClick(View view) {
        ...
        {
            Intent intent=new Intent(YoutubePlayervideos.this,YoutubeActivity.class);
